const Map<String, String> en_US = {
  ...
  "languageSetting": "Language Setup",
  "language": "Language",
  "english": "English",
  "chinese": "Chinese",
  ...
  "mergeForwardHint": "[Combine and Forward] item(%s)",
  ...
  "friendPermissionsSetting": "Privacy",
  "moreInfo": "More",
  ...
  "deleteUserModalTitle": "Account Deletion Reminder",
  "deleteUserModalTips":
      "Please confirm again if you want to cancel the account",
  "deleteUserModalBtn1": "Confirm Deletion",
  "deleteUserModalBtn2": "Cancel",
  ...
  "infringement": "Infringing activities",
  ...
  "invitationReason": "Please enter a reason for the invitation",
  ...
  "consecutiveSignIn": "Consecutive Sign-in",
  ...
  "recommend": "Recommend",
  "complaint2": "Report",
  "riskyLocation": "Hazardous Location",
  "suspectedFraud": "Suspected Fraud",
  "pornography": "Pornographic or Vulgar Content",
  "illegalActivities": "Illegal Activity",
  "politicalSensitivity": "Politically Sensitive",
  "falseInformation": "Misleading Information",
  "involvingMinors": "Involves Minors",
  "abuse": "Abusive or Incites Conflict",
  "publicOrder": "Violates Public Morals",
  "spamAds": "Spam Ads",
  "personalSafety": "Threatens Physical Safety",
  "plagiarism": "Plagiarism",
  "infringement2": "Infringes on Rights",
  "illegalSales": "Unauthorized Sales",
  "other": "Other",
    "selectFriends": "Select Contacts",
  "oneByOneForwardHint": "[Forward one by one] A total of %s messages",
  "oneByOneForward": "Forward one by one",
  "googleOAuth2Login": "Google Web Login",
  "googleLogin": "Google Login",
  "facebookLogin": "Facebook Login",
  "appleLogin": "Apple Login",
  "mitiID": "mitiID",
  "changeMitiIDTips": "mitiID is your unique identifier on miti and can only be changed once a year.",
  "changeMitiID": "Change mitiID",
  "enterMitiID": "Enter new mitiID",
  "mitiIDRules": "Length limit is 6-20 characters, must start with a letter or underscore, and can use numbers, letters, underscores, hyphens, or their combinations.",
  "enterRightMitiID": "Please enter your new mitiID according to the modification rules.",
  "newMitiID": "New mitiID",
  "newMitiIDRule": "mitiID can only be changed once a year.",
  "agreeChangeMitiID1": "I have read and agree to the",
  "agreeChangeMitiID2": "important notice on",
  "agreeChangeMitiID3": "changing mitiID",
  "openAngleBracket": "《",
  "closeAngleBracket": "》",
  "changeMitiRule1": "Important Notice on Changing mitiID",
  "changeMitiRule2": "1. After changing mitiID, other users on the platform will not be able to search and add you using your old mitiID.",
  "changeMitiRule3": "2. mitiID can only be changed once a year, once changed, it cannot revert to the old mitiID, please confirm carefully.",
  "changeMitiRule4": "3. After changing mitiID, the related data bound on the platform will not change due to the mitiID modification, similarly, third-party services logged in and used via miti authorization will not be affected by the change.",
  "changeMitiRule5": "4. The change of mitiID must still comply with the 'miti Service Agreement' and other related agreements and specifications, and your new mitiID cannot be the same as someone else's current or previous mitiID.",
  ...
  "empty": "No Data",
  "invited": "Invited",
  "waitingAgree": "Pending Confirmation",
  "activeAccount": "Activate Account",
  "changeInviter": "Change Inviter",
  "activeAccountTips": "Thank you for your patience. Friend %s has activated miti for you!",
  "activeAccountTips2": "Thank you for your patience. Your friend has activated miti for you!",
  "goHome": "Get Start",
  "plsEnterRightInvitationCode": "Please enter the correct invitation code",
  "inviteSuccess": "Invitation Successful",
  "idInvite": "Invite with mitiID",
  "qrcodeInvite": "Invite with QR Code",
  "urlInvite": "Invite with Share Link",
  "share": "Share",
  "submitMitiIDSuccess": "Waiting for your friend to confirm the activation. Thank you for supporting miti.",
  "enterInviterId": "Please enter the inviter's ID",
  "inviteDialogTips": "User %s has used your invitation code and wants to join miti. Do you want to activate the account for them and add them as a friend by default?",
  "inviteDialogSuccessTips": "Thank you for your patience. Friend %s has activated miti for you!",
  "inviteDialogFailTips": "Friend %s has declined your activation request.",
  "goStart": "Get Started",
  "submitError": "Submission Failed",
  "waitingActive": "Pending Activation",
  "activeTips": "Your miti account is currently inactive and cannot use the AI function module on the miti platform. Activate your miti account to start the full miti experience!",
  "goActive": "Go Activate",
  "activeAccountNotificationTitle": "Received an Activation Request",
  "activeAccountResultNotificationTitle": "Received an Activation Result",
  "submitActiveSuccess": "Activation Request Submitted Successfully",
  "inviteInstructions1": "Invitation Process Instructions",
  "inviteInstructions2": "1. Invitation Link Generation",
  "inviteInstructions3": "· After logging into the app, users can find the option to invite friends on their personal account page or specific event page.",
  "inviteInstructions4": "· After clicking 'Invite Friends', the system will generate a unique invitation link or code.",
  "inviteInstructions5": "2. Share Invitation Link",
  "inviteInstructions6": "Users can share the invitation link through various methods, including but not limited to social media, text messages, and emails."
