const Map<String, String> en_US = {
  ...
  "mitiID": "mitiID",
  "changeMitiIDTips":
      "mitiID is your unique identifier on miti and can only be changed once a year.",
  "changeMitiID": "Change mitiID",
  "enterMitiID": "Enter new mitiID",
  "mitiIDRules":
      "Length limit is 6-20 characters, must start with a letter or underscore, and can use numbers, letters, underscores, hyphens, or their combinations.",
  "enterRightMitiID":
      "Please enter your new mitiID according to the modification rules.",
  ...
  "changeMitiRule2":
      "1. After changing mitiID, other users on the platform will not be able to search and add you using your old mitiID.",
  "changeMitiRule3":
      "2. mitiID can only be changed once a year, once changed, it cannot revert to the old mitiID, please confirm carefully.",
  "changeMitiRule4":
      "3. After changing mitiID, the related data bound on the platform will not change due to the mitiID modification, similarly, third-party services logged in and used via miti authorization will not be affected by the change.",
  "changeMitiRule5":
      "4. The change of mitiID must still comply with the 'miti Service Agreement' and other related agreements and specifications, and your new mitiID cannot be the same as someone else's current or previous mitiID.",
  ...
  "activeAccountTips":
      "Thank you for your patience. Friend %s has activated miti for you!",
  "activeAccountTips2":
  ...
  "share": "Share",
  "submitMitiIDSuccess":
      "Waiting for your friend to confirm the activation. Thank you for supporting miti.",
  "enterInviterId": "Please enter the inviter's ID",
  "inviteDialogTips":
      "User %s has used your invitation code and wants to join miti. Do you want to activate the account for them and add them as a friend by default?",
  "inviteDialogSuccessTips":
      "Thank you for your patience. Friend %s has activated miti for you!",
  ...
  "activeTips":
      "Your miti account is currently inactive and cannot use the AI function module on the miti platform. Activate your miti account to start the full miti experience!",
  ...
  "inviteInstructions3":
      "· After logging into the app, users can find the option to invite friends on their personal account page or specific event page.",
  "inviteInstructions4":
      "· After clicking 'Invite Friends', the system will generate a unique invitation link or code.",
