...
class ChatRecordVoiceView extends StatefulWidget {
  ...
  final Widget Function(BuildContext context, int sec, int _startTimestamp)
      builder;
...
class _ChatRecordVoiceViewState extends State<ChatRecordVoiceView> {
  ...
  void dispose() {
    (() async {
      try {
        ...
        myLogger.e({
          "message": "ChatRecordVoiceView 停止录制语音异常",
          "error": e,
          "stack": s
        });
      }
  ...
  Widget build(BuildContext context) =>
      widget.builder.call(context, _duration, _startTimestamp);
}
