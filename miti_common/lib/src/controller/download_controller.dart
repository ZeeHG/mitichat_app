...
class DownloadController extends GetxController {
  ...
  bool isExistMessageTask(Message message) =>
      message.isFileType &&
      null != message.fileElem?.sourceUrl &&
      isExistTask(message.fileElem!.sourceUrl!);

  ValueNotifier<DownloadStatus> getStatus(Message message) =>
      downloadTaskList[message.fileElem!.sourceUrl!]!.status;

  ValueNotifier<double> getProgress(Message message) =>
      downloadTaskList[message.fileElem!.sourceUrl!]!.progress;
