package miti.live.alert.flutter_miti_live_alert.services;
...
import miti.live.alert.flutter_miti_live_alert.FlutterMitiLiveAlertPlugin;
import miti.live.alert.flutter_miti_live_alert.R;
...
public class CallService extends Service {
    ...
    public void onCreate() {
        ...
        mRejectButton.setOnClickListener(view -> {
            FlutterMitiLiveAlertPlugin.channel.invokeMethod("reject", null);
        });
        mAcceptButton.setOnClickListener(view -> {
            FlutterMitiLiveAlertPlugin.channel.invokeMethod("accept", null);
        });
